...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_COLONS = 4,                     /* COLONS  */
  YYSYMBOL_WORD = 5,                       /* WORD  */
  YYSYMBOL_HTTP_METHOD = 6,                /* HTTP_METHOD  */
  YYSYMBOL_7_n_ = 7,                       /* '\n'  */
  YYSYMBOL_YYACCEPT = 8,                   /* $accept  */
  YYSYMBOL_input = 9,                      /* input  */
  YYSYMBOL_line = 10,                      /* line  */
  YYSYMBOL_cmd_list = 11,                  /* cmd_list  */
  YYSYMBOL_param_list = 12                 /* param_list  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "COMMA", "COLONS",
  "WORD", "HTTP_METHOD", "'\\n'", "$accept", "input", "line", "cmd_list",
...
{
       0,     4,     5,     6,     9,    10,    11,     5,    12,     5,
       0,     7,     3,     4,     3,     5,    10,     5,    12,     5
};
